    ...
    $students = $attempts
        ...
        ->map(function ($attempts, $name) {
            ...
            return [
                ...
                // category columns
                'spoken_english' => $categoryScores['spoken-english'] ?? null,
                'physics' => $categoryScores['physics'] ?? null,
                'maths' => $categoryScores['general-maths'] ?? null,
                'computer' => $categoryScores['basic-computer'] ?? null,
                'general_knowledge' => $categoryScores['general-knowledge'] ?? null,
                'public_speaking' => $categoryScores['public-speaking'] ?? null,
            ];
        })
        ->values();
